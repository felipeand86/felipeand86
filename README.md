...
<ul>
 ...
 <img src="https://skillicons.dev/icons?i=html,css,js,ts,react,vscode,dart,py">
  </ul>
  
 <ul> 
 <li><p><strong>Back-end</strong></p>
 <img src="https://skillicons.dev/icons?i=nodejs,sqlite,py">
 </ul>

 <ul>
 <li><p><strong>Desk e Mobile</strong></p> 
 <img src="https://skillicons.dev/icons?i=dart,flutter,py">
</div>
